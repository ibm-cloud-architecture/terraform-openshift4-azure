...
output "apps_lb_pip_ip" {
  value = "${data.azurerm_public_ip.worker_public_ip.ip_address}"
}
...
output "cluster_image_id" {
  value = "/resourceGroups/${var.cluster_id}-rg/providers/Microsoft.Compute/images/${var.cluster_id}"
}

output "bootstrap_public_ip" {
  value = azurerm_public_ip.bootstrap_public_ip.ip_address
}
